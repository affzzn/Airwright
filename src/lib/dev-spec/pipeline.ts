...
export const SCHEMA_FIELDS: SchemaField[] = [
  ...
  { name: "structure", type: "SINGLE | PAIR_OR_TERRACE | APARTMENT_BLOCK | null", meaning: "Decides how the take-off is split." },
  ...
  { name: "cornerCount", type: "number field", meaning: "External corners/returns (rectangle = 4)." },
  { name: "dwellingsWide", type: "number field", meaning: "How many dwellings share the frontage (engine divides front/rear)." },
  { name: "floorAreas", type: "array of floors", meaning: "Raw birdcage inputs per floor (stated areas + rectangles)." },
