...
const COMPONENT_OPTS: { value: string; label: string }[] = [
  ...
  { value: "ADAPTION_INSIDE_BOARD", label: "Inside-board adaption LM (TF)" },
  { value: "ADAPTION_HOP_UP", label: "Hop-up adaption LM (TF)" },
  { value: "ADAPTION_INSIDE_BOARD_APEX", label: "Inside-board apex adaption (TF, unit)" },
  { value: "ADAPTION_HOP_UP_APEX", label: "Hop-up apex adaption (TF, unit)" },
